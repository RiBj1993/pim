...
public class SVGActivity extends com.nightonke.wowoviewpagerexample.WoWoActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSvg(svgView0, com.nightonke.wowoviewpagerexample.svg.SVG.GOOGLE);
        setSvg(svgView1, com.nightonke.wowoviewpagerexample.svg.SVG.GITHUB);
        setSvg(svgView2, com.nightonke.wowoviewpagerexample.svg.SVG.TWITTER);
        setSvg(svgView3, com.nightonke.wowoviewpagerexample.svg.SVG.JRUMMY_APPS);
        setSvg(svgView4, com.nightonke.wowoviewpagerexample.svg.SVG.BUSYBOX_LOGO);
    ...
    private void setSvg(WoWoSvgView svgView, com.nightonke.wowoviewpagerexample.svg.SVG svg) {
