...
public class CustomAnimationActivity extends com.nightonke.wowoviewpagerexample.WoWoActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wowo.addAnimation(text)
                .add(com.nightonke.wowoviewpagerexample.CustomAnimation.builder().page(0).from(0).to(10).build())
                .add(com.nightonke.wowoviewpagerexample.CustomAnimation.builder().page(1).from(10).to(20).build())
                .add(com.nightonke.wowoviewpagerexample.CustomAnimation.builder().page(2).from(20).to(0).build())
                .add(com.nightonke.wowoviewpagerexample.CustomAnimation.builder().page(3).from(0).to(30).build());
