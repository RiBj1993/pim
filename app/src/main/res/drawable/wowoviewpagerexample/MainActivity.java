    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.wowo_path_animation:
                ...
                break;
            case R.id.gearbox:
                startActivity(new Intent(this, com.nightonke.wowoviewpagerexample.GearboxActivity.class));
                return;
            case R.id.static_view_pager:
                startActivity(new Intent(this, com.nightonke.wowoviewpagerexample.StaticActivity.class));
                return;
            case R.id.auto_scroll:
                startActivity(new Intent(this, AutoScrollActivity.class));
                return;
            case R.id.direction:
                startActivity(new Intent(this, com.nightonke.wowoviewpagerexample.DirectionActivity.class));
                return;
            case R.id.svg_expansibility:
                startActivity(new Intent(this, com.nightonke.wowoviewpagerexample.svg.SVGActivity.class));
                return;
            ...
            case R.id.guide_page_1:
                startActivity(new Intent(this, com.nightonke.wowoviewpagerexample.GuidePageActivity1.class));
                return;
            case R.id.guide_page_2:
                startActivity(new Intent(this, com.nightonke.wowoviewpagerexample.GuidePageActivity2.class));
                return;
        }
