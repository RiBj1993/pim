...
public class CustomAnimation extends PageAnimation {
    ...
    public static class Builder extends PageAnimation.Builder<com.nightonke.wowoviewpagerexample.CustomAnimation.Builder> {
        ...
        public com.nightonke.wowoviewpagerexample.CustomAnimation build() {
            checkUninitializedAttributes();
            return new com.nightonke.wowoviewpagerexample.CustomAnimation(page, startOffset, endOffset, ease, interpolator, useSameEaseEnumBack, fromElevation, toElevation);
        }
