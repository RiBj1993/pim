package mobile.esprit.pim.USER;
...
public class SessionManager {
    ...
    public static final String KEY_IDObject = "user_ object";
    ...
    public void checkLogin(){
        ...
        if(!this.isLoggedIn()){
            ...
            Intent i = new Intent(_context, one.class);
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        user.put(KEY_IDObject, pref.getString(KEY_IDObject, null));
        // return user
        return user;
    }
    /**
