            ...
            public void onClick(View view) {
                ...
                try {
                    if (isOnline()) {
                        ...
                        String check = null;
                        AsyncTask checkLoginTask = new CheckLogin().execute("http://" + SessionManager.ADDRESS + "/pim/checkLogin.php?" +
                                "mail=" + identityField.getText() + "&login_in=" + passwordField.getText());
                        checkLoginTask.get();
